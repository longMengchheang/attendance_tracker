          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
                ...
                <input
                    ...
                    className={`w-full border rounded-xl p-3 pl-10 bg-gray-50 focus:bg-white focus:ring-2 outline-none transition-all shadow-inner text-gray-900 ${formData.confirmPassword && formData.password !== formData.confirmPassword ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-gray-200 focus:border-[#F43F5E] focus:ring-[#F43F5E]/20'}`}
