  ...
  return (
    <aside className="w-60 bg-[#F43F5E] text-white flex flex-col h-screen fixed left-0 top-0 overflow-y-auto font-sans">
      ...
      <div className="p-6 flex items-center space-x-3 border-b border-white/10">
        ...
        <div>
          <h2 className="font-semibold text-lg leading-tight">Mengchheang</h2>
      ...
      <div className="p-4 border-t border-white/10 mt-auto">
        <button className="flex items-center space-x-3 px-4 py-3 w-full text-left text-white/70 hover:bg-white/10 hover:text-white rounded-lg transition-colors">
            <LogOut size={20} />
            <span>Sign Out</span>
        </button>
      </div>
